...
\restrict tzr71IQVm6gBD1N5pyayHpp98LRc5xkjGkYOu5PjOdMHwBn44yQ0xk3UYTvo791
...
CREATE TABLE public.expert_expertlistingpage (
    ...
    info_group_section_description text NOT NULL,
...
CREATE TABLE public.knowledge_knowledgecontenttypecard_tags (
    id bigint NOT NULL,
    knowledgecontenttypecard_id uuid NOT NULL,
    knowledgetopic_id uuid NOT NULL
);
...
CREATE TABLE public.knowledge_knowledgelistingpage (
    ...
    featured_section_heading character varying(300) NOT NULL,
    ...
    meta_title character varying(200) NOT NULL,
    meta_description character varying(300) NOT NULL,
    filter_section_description text NOT NULL,
    ...
    hero_cta_secondary_label character varying(100) NOT NULL,
    ...
    content_type_section_bg_decoration character varying(100) NOT NULL,
    content_type_section_bg_image character varying(100) NOT NULL,
    content_type_section_cta_icon character varying(50) NOT NULL,
    content_type_section_cta_text character varying(100) NOT NULL,
    content_type_section_cta_url character varying(500) NOT NULL,
    content_type_section_description text NOT NULL,
    content_type_section_heading character varying(300) NOT NULL,
    content_type_section_label character varying(200) NOT NULL,
    topic_section_bg_decoration character varying(100) NOT NULL,
    topic_section_bg_image character varying(100) NOT NULL,
    topic_section_description text NOT NULL,
    ...
    pub_form_email_placeholder character varying(200) NOT NULL,
    pub_form_name_label character varying(100) NOT NULL,
    pub_form_name_placeholder character varying(200) NOT NULL,
    pub_form_note_label character varying(100) NOT NULL,
    pub_form_note_placeholder text NOT NULL,
    pub_form_org_label character varying(100) NOT NULL,
    pub_form_org_placeholder character varying(200) NOT NULL,
    pub_form_privacy_note text NOT NULL,
    pub_form_success_message text NOT NULL,
    pub_form_title character varying(300) NOT NULL,
    pub_section_bg_decoration character varying(100) NOT NULL,
    ...
    news_section_bg_decoration character varying(100) NOT NULL,
    ...
    press_section_description text NOT NULL,
    ...
    ready_section_description text DEFAULT ''::text NOT NULL,
    ready_section_is_active boolean DEFAULT true NOT NULL,
    ready_section_overlay_color character varying(30) DEFAULT '#0d1e4a'::character varying NOT NULL,
    ready_section_overlay_opacity double precision DEFAULT 0.82 NOT NULL,
    ready_section_subtitle character varying(200) DEFAULT ''::character varying NOT NULL,
    ready_section_text_color character varying(20) DEFAULT 'light'::character varying NOT NULL,
...
CREATE TABLE public.knowledge_knowledgenewsitem_topics (
    id bigint NOT NULL,
    knowledgenewsitem_id uuid NOT NULL,
    knowledgetopic_id uuid NOT NULL
);
...
CREATE TABLE public.knowledge_knowledgetopiccard_tags (
    id bigint NOT NULL,
    knowledgetopiccard_id uuid NOT NULL,
    knowledgetopiccardtag_id uuid NOT NULL
);
...
1	pbkdf2_sha256$1000000$a558al4x3g4iBdJfyfjtpp$QfsH1eBfHDrVgsytW4KPbC6aTDBR3HO8zN2M96ZnA1s=	2026-09-14 10:39:41.806963+07	t	admin			admin@gmail.com	t	t	2026-07-02 21:42:09.329047+07
\.
...
49ba24be-3bc5-4500-af47-42388c2376cc	t	5	2026-09-14 12:06:06.098759+07	2026-09-14 12:57:39.224847+07	knowledge/activity_news/3._Giaoduc_phattriennangluc_1.png	IRDM TỔ CHỨC KHÓA ĐÀO TẠO “NGHIỆP VỤ THƯ KÝ KHOA HỌC ĐỀ TÀI KHOA HỌC VÀ CÔNG NGHỆ CẤP TỈNH/THÀNH PHỐ”	Khóa đào tạo trang bị kiến thức, kỹ năng và kinh nghiệm thực tiễn về xây dựng, quản lý hồ sơ, điều phối và hỗ trợ triển khai nhiệm vụ KH&CN cấp tỉnh/thành phố;\r\nTags: Nguồn nhân lực | Cơ quan quản lý | Trường đại học | Hệ thống y tế;\r\nNgày: 13–15/05/2026 và 10–12/06/2026;\r\nĐịa điểm: Viện Nghiên cứu Phát triển Nguồn lực Việt | Trực tiếp;	2026-09-14	Xem chi tiết	arrow-right		t	0cb0cf05-8816-4776-a57c-860432aa5fac	_self	irdm-t-chc-khoa-djao-to-nghip-v-th-ky-khoa-hc-dj-tai-khoa-hc-va-cong-ngh-cp-tnhthanh-ph		<p>Trong tháng 5 và tháng 6/2026, Viện Nghiên cứu Phát triển Nguồn lực Việt (IRDM) đã tổ chức hai khóa đào tạo “Nghiệp vụ Thư ký khoa học đề tài khoa học và công nghệ cấp tỉnh/thành phố” tại trụ sở Viện IRDM, số 8C Trần Huy Liệu, Phường Phú Nhuận, TP.HCM.</p><p>Khóa 1 diễn ra từ ngày 13 đến ngày 15/05/2026; Khóa 2 được tổ chức từ ngày 10 đến ngày 12/06/2026. Trong ba ngày học của mỗi khóa, học viên được tiếp cận kiến thức, quy trình và kinh nghiệm thực tiễn liên quan đến việc xây dựng, quản lý và hỗ trợ triển khai nhiệm vụ khoa học và công nghệ.</p><p>[ẢNH TOÀN CẢNH LỚP HỌC]</p><p>&nbsp;</p><figure class=""><table><tbody><tr><td><figure class="image image-style-align-left"><img height="465" src="/media/knowledge/articles/body/3.%20Giaoduc_phattriennangluc_2.png" width="723"></figure></td><td><figure class="image image-style-align-left"><img height="464" src="/media/knowledge/articles/body/3.%20Giaoduc_phattriennangluc_3.png" width="619"></figure></td><td>&nbsp;</td><td>&nbsp;</td></tr></tbody></table></figure><p>Chương trình có sự đồng hành của&nbsp;<strong>ThS. Hồng Phấn</strong>, giảng viên có nhiều năm kinh nghiệm trong tư vấn, giảng dạy và điều phối các dự án khoa học và công nghệ cấp tỉnh/thành phố. Với phương pháp trình bày hệ thống, gần gũi và gắn với các tình huống thực tế, giảng viên đã giúp học viên hiểu rõ hơn những yêu cầu chuyên môn và nghiệp vụ trong toàn bộ quá trình triển khai một nhiệm vụ khoa học và công nghệ.</p><p>Nội dung đào tạo tập trung vào các chủ đề trọng tâm:</p><ul><li>Quy trình quản lý đề tài khoa học và công nghệ cấp tỉnh/thành phố.&nbsp;</li><li>Xây dựng hồ sơ đề xuất nhiệm vụ và hồ sơ tham gia đấu thầu.&nbsp;</li><li>Xây dựng hồ sơ sở hữu trí tuệ đối với sản phẩm khoa học và công nghệ.&nbsp;</li><li>Soạn thảo, kiểm soát, quản lý và lưu trữ hồ sơ trong quá trình triển khai đề tài.&nbsp;</li><li>Các lưu ý pháp lý và kinh nghiệm thực tiễn khi tổ chức thực hiện nhiệm vụ khoa học và công nghệ.&nbsp;</li></ul><p>&nbsp;</p><figure class=""><table><tbody><tr><td><figure class="image"><img height="708" src="/media/knowledge/articles/body/3.%20Giaoduc_phattriennangluc_4.png" width="933"></figure></td></tr></tbody></table></figure><p>[ẢNH GIẢNG VIÊN TRÌNH BÀY]</p><p>&nbsp;</p><p>Bên cạnh kiến thức nền tảng, chương trình chú trọng phân tích hồ sơ, biểu mẫu và những vấn đề thường phát sinh trong thực tế. Học viên được trực tiếp trao đổi với giảng viên, chia sẻ khó khăn tại đơn vị và cùng thảo luận những phương án xử lý phù hợp.</p><p>Khóa học thu hút sự tham gia của các nhà nghiên cứu, nghiên cứu viên, giảng viên và những cá nhân đang xây dựng, triển khai hoặc quan tâm đến nhiệm vụ khoa học và công nghệ cấp tỉnh/thành phố. Sự đa dạng về chuyên môn và môi trường công tác đã tạo nên không gian học tập cởi mở, với nhiều câu hỏi thực tế và góc nhìn đa chiều.</p><p>[ẢNH HỌC VIÊN TRAO ĐỔI, THẢO LUẬN HOẶC THỰC HÀNH TẠI LỚP]</p><p>&nbsp;</p><figure class=""><table><tbody><tr><td><figure class="image"><img height="490" src="/media/knowledge/articles/body/3_M8D2cpL.%20Giaoduc_phattriennangluc_5.png" width="653"></figure></td><td><figure class="image"><img height="470" src="/media/knowledge/articles/body/3_41m9f1y.%20Giaoduc_phattriennangluc_6.png" width="670"></figure></td></tr></tbody></table></figure><p>Thông qua chương trình, học viên có điều kiện hiểu rõ hơn vai trò của thư ký khoa học trong quá trình triển khai nhiệm vụ. Thư ký khoa học không chỉ hỗ trợ công tác hành chính, mà còn tham gia kết nối và phối hợp giữa chủ nhiệm nhiệm vụ, tổ chức chủ trì, cơ quan quản lý, chuyên gia và các bên liên quan. Việc nắm vững quy trình, hồ sơ và yêu cầu pháp lý là cơ sở quan trọng để hỗ trợ nhiệm vụ được triển khai đúng tiến độ, đúng quy định và hạn chế những thiếu sót phát sinh.</p><p>Khóa đào tạo là một phần trong định hướng của IRDM về chuyển hóa tri thức chuyên môn thành chương trình học tập có cấu trúc, gắn với tình huống thực tế và nhu cầu phát triển năng lực của người học.</p><p>IRDM trân trọng cảm ơn&nbsp;<strong>ThS. Hồng Phấn</strong>&nbsp;đã đồng hành cùng chương trình bằng kinh nghiệm thực tiễn, sự tận tâm và tinh thần trách nhiệm. Viện cũng trân trọng cảm ơn Quý Anh/Chị học viên đã tham gia với tinh thần nghiêm túc, chủ động và cởi mở, góp phần tạo nên hai hành trình học tập thiết thực và giàu giá trị ứng dụng.</p><p>Trong thời gian tới, IRDM dự kiến tiếp tục phát triển các chương trình chuyên sâu về nghiệp vụ thư ký khoa học và quản lý nhiệm vụ khoa học và công nghệ, tăng cường nội dung thực hành, xử lý tình huống và kết nối cộng đồng những cá nhân đang nghiên cứu, công tác trong lĩnh vực này.</p><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p><p>[ẢNH TẬP THỂ GIẢNG VIÊN VÀ HỌC VIÊN CUỐI KHÓA]</p><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p><figure class=""><table><tbody><tr><td><figure class="image"><img src="/media/knowledge/articles/body/3_jPi1CO1.%20Giaoduc_phattriennangluc_7.png"></figure></td></tr><tr><td><figure class="image"><img height="551" src="/media/knowledge/articles/body/3_eSs6ZF7.%20Giaoduc_phattriennangluc_8.png" width="992"></figure></td></tr></tbody></table></figure><p>&nbsp;</p><p>#IRDM #GiaoDucVaPhatTrienNangLuc #KhoaHocCongNghe #ThuKyKhoaHoc #DeTaiKHCN #NghienCuuKhoaHoc #DoiMoiSangTao</p>	Nguyễn Yến Nhi	6		
\.
...
94922265-aba4-4be9-8057-a744b4f97ace	t	0	2026-09-13 09:54:17.371677+07	2026-09-13 09:55:05.285579+07	BloomHub - Mô hình học tập và đổi mới tích hợp	bloomhub-mo-hinh-hc-tp-va-dji-mi-tich-hp22	Ngày 09/8, Viện Nghiên cứu Phát triển Nguồn lực Việt (IRDM) chính thức khai trương BloomHub – một khu phức hợp học tập, chia sẻ và đổi mới do IRDM kiến tạo, dành riêng cho thế hệ trẻ Việt Nam. Sự kiện này đánh dấu cột mốc 5 năm nỗ lực thực hiện sứ mệnh “Nâng tầm nguồn lực trẻ Việt Nam – Đổi mới, Sáng tạo, Bền vững” của Viện.	knowledge/news/z6889926896838_b6bc4266b3cdd4c3a73b8eea9e077d651.jpg	2026-09-13	https://tuoitre.vn/khoahocphothong/bloomhub-mo-hinh-hoc-tap-va-doi-moi-tich-hop-104260788.htm	t	\N	_blank	Xem chi tiết	t
...
SELECT pg_catalog.setval('public.knowledge_knowledgenewsitem_topics_id_seq', 30, true);
...
\unrestrict tzr71IQVm6gBD1N5pyayHpp98LRc5xkjGkYOu5PjOdMHwBn44yQ0xk3UYTvo791
